...
import { faThumbsUp, faUsers, faHandshake, faGear } from '@fortawesome/free-solid-svg-icons';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import React from 'react';

library.add(faUsers, faThumbsUp, faHandshake, faGear)
...
const Summary = () => {
    const summaries = [
        ...
        { number: '250+', name: 'Different Products', icon: 'fa-gear' }
    ]
    return (
        <div className='my-32'>
            <h2 className='text-3xl font-semibold text-center'>Maintaining Quality Worldwide</h2>
            <div className='grid lg:grid-cols-4 grid-cols-2 gap-5 mx-10 my-16 justify-center items-center cursor-pointer'>
                {
                    summaries.map(summary => <div class="card bg-transparent text-neutral-focus border transition-all hover:-translate-y-10 hover:bg-neutral hover:text-neutral-content">
